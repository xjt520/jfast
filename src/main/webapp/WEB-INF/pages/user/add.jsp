        ...
        <form id="form_${timer }" method="post">
            <table style="width: 100%">
                    <tr>
                        ...
                        <td width="82%">
                            <input class="easyui-textbox" data-options="required:true,validType:['length[0,50]']" style="width:200px;height:32px" id="loginName_${timer }" name="loginName" />
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td width="82%">
                            <input class="easyui-textbox" data-options="required:true,validType:['length[0,50]']" style="width:200px;height:32px" id="eamil_${timer }" name="eamil" />
                        </td>
                    </tr>
                    <tr>
                        <td width="18%">手机号:<label style="color: red">*</label></td>
                        <td width="82%">
                            <input class="easyui-textbox" data-options="required:true,validType:['length[0,50]']" style="width:200px;height:32px" id="mobile_${timer }" name="mobile" />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td width="82%">
                            ...
                            <%--<input class="easyui-textbox" data-options="required:true,validType:['length[0,50]']" style="width:200px;height:32px" id="status_${timer }" name="status" />--%>
                        </td>
                    </tr>
<%--                    <tr>
                        <td width="18%">激活码:<label style="color: red">*</label></td>
                        <td width="82%">
                            <input class="easyui-textbox" data-options="required:true,validType:['length[0,50]']" style="width:200px;height:32px" id="activationKey_${timer }" name="activationKey" />
                        </td>
                    </tr>--%>
            </table>
