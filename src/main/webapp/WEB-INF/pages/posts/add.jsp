...
//            imageUrlPrefix: "http://readshe.com/nbst"
    });
        ...
        <form id="form_${timer }" method="post">
            <table style="width: 100%">
                    <tr>
                        ...
                        <td width="82%">
                            <input class="easyui-textbox" data-options="required:true,validType:['length[0,50]']" style="width:200px;height:32px" id="postTitle_${timer }" name="posts.postTitle" />
                        </td>
                    </tr>
                    <tr>
                        <td width="18%">分类:<label style="color: red">*</label></td>
                        <td width="82%">
                            <input class="easyui-combobox" name="posts.postCategory" id="postCategory_${timer }" style="width:200px;height:32px"
                    ...
                    <tr>
                        ...
                        <td width="82%">
                            <input class="easyui-textbox" data-options="required:true,validType:['length[0,50]']" style="width:400px;height:32px" id="postExcerpt_${timer }" name="posts.postExcerpt" />
                        </td>
                    </tr>
                    <tr>
                        <td width="18%"></td>
                        <td width="82%">
                            <!-- 加载编辑器的容器 -->
                            <script id="editor_${timer }" name="posts.postContent" type="text/plain">正文</script>
                        </td>
                    </tr>
            </table>
